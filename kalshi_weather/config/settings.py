...
ALERT_POSITION_LOSS_FRACTION = float(os.getenv("ALERT_POSITION_LOSS_FRACTION", "0.25"))
...
ALERT_SOURCE_CHANGE_ENABLED = os.getenv("ALERT_SOURCE_CHANGE_ENABLED", "true").lower() == "true"
ALERT_SOURCE_CHANGE_MIN_DELTA_F = float(os.getenv("ALERT_SOURCE_CHANGE_MIN_DELTA_F", "0.5"))
ALERT_OBS_DIVERGENCE_ENABLED = os.getenv("ALERT_OBS_DIVERGENCE_ENABLED", "true").lower() == "true"
ALERT_OBS_DIVERGENCE_TEMP_F = float(os.getenv("ALERT_OBS_DIVERGENCE_TEMP_F", "2.5"))
ALERT_OBS_DIVERGENCE_EXCEED_PROB = float(os.getenv("ALERT_OBS_DIVERGENCE_EXCEED_PROB", "0.25"))
ALERT_OBS_DIVERGENCE_LOCK_CONFIDENCE = float(os.getenv("ALERT_OBS_DIVERGENCE_LOCK_CONFIDENCE", "0.75"))
ALERT_HOURLY_UPDATE_ENABLED = os.getenv("ALERT_HOURLY_UPDATE_ENABLED", "false").lower() == "true"
ALERT_HOURLY_UPDATE_MINUTE_LOCAL = int(os.getenv("ALERT_HOURLY_UPDATE_MINUTE_LOCAL", "53"))
